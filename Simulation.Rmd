...
generate = function(n, # number of observations
                    ...
                    ps = floor(0.5*p*ratio[1]/sum(ratio)), # number of strong signals
                    pwbc = floor(0.5*p*ratio[2]/sum(ratio)), # number of WBC signals
                    pwai = floor(0.5*p*ratio[3]/sum(ratio)), # number of WAI signals
...
param_estimate = simulation(n = 100, p = 100, ratio = c(1,4,5), corr = 0.6, param_table = param_estimate)
param_estimate = simulation(n = 500, p = 100, ratio = c(1,4,5), corr = 0.6, param_table = param_estimate)
param_estimate = simulation(n = 2000, p = 100, ratio = c(1,4,5), corr = 0.6, param_table = param_estimate)
...
param_estimate = data.frame(matrix(ncol = 0, nrow = 0))
param_estimate = simulation(n = 100, p = 100, ratio = c(3,3,4), corr = 0.6, param_table = param_estimate)
param_estimate = simulation(n = 500, p = 100, ratio = c(3,3,4), corr = 0.6, param_table = param_estimate)
param_estimate = simulation(n = 2000, p = 100, ratio = c(3,3,4), corr = 0.6, param_table = param_estimate)
