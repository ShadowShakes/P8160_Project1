...
## Signal Identification Metrics

Define the true predictors to be positive and the null predictors to be negative.\par
...
Denote the estimation of $\beta$ as $\hat{\beta} = (\hat{\beta_1}, \hat{\beta_2}, ..., \hat{\beta_n})$.\par

- \textbf{Bias:} $\frac{1}{p}\sum_{i=1}^p (\hat{\beta_i}-\beta_i)$
