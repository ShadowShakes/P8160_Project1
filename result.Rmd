...
# compare specificity
ggplot(fit_identify_result %>% filter(ratio == 145), aes(x = method, y = specificity, color = n)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Sensitivity",x = "method", y = "specificity")

# compare F1-score
ggplot(fit_identify_result %>% filter(ratio == 145), aes(x = method, y = F1_score, color = n)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Sensitivity",x = "method", y = "F1_score")

# compare accuracy
ggplot(fit_identify_result %>% filter(ratio == 145), aes(x = method, y = accuracy, color = n)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Sensitivity",x = "method", y = "accuracy")
```
...
# First ratio
ggplot(fit_identify_result_type %>% filter(ratio == 145), aes(x = method, y = sensitivity, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "sensitivity") +
  facet_grid(. ~ n)

ggplot(fit_identify_result_type %>% filter(ratio == 145), aes(x = method, y = specificity, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "specificity") +
  facet_grid(. ~ n)

ggplot(fit_identify_result_type %>% filter(ratio == 145), aes(x = method, y = F1_score, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "F1_score") +
  facet_grid(. ~ n)

ggplot(fit_identify_result_type %>% filter(ratio == 145), aes(x = method, y = accuracy, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
...
# Second ratio
ggplot(fit_identify_result_type %>% filter(ratio == 334), aes(x = method, y = sensitivity, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "sensitivity") +
  facet_grid(. ~ n)

ggplot(fit_identify_result_type %>% filter(ratio == 334), aes(x = method, y = specificity, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "specificity") +
  facet_grid(. ~ n)

ggplot(fit_identify_result_type %>% filter(ratio == 334), aes(x = method, y = F1_score, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "F1_score") +
  facet_grid(. ~ n)

ggplot(fit_identify_result_type %>% filter(ratio == 334), aes(x = method, y = accuracy, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "accuracy") +
  facet_grid(. ~ n)
...
ggplot(fit_identify_result_type %>% filter(n == 100), aes(x = method, y = accuracy, color = type)) + 
  geom_boxplot() +
  theme(legend.position = "right") +
  labs(title = "Plot of length  per dose",x = "method", y = "accuracy") +
  facet_grid(. ~ ratio)
