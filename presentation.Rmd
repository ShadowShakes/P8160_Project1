...
\begin{figure} 
  \centering 
  \subfigure[Beta RMSE when n=100]{ 
    \label{sub1}
    \includegraphics[width=2.0in]{Images/g9.pdf} 
  } 
  \subfigure[Beta Variance when n=100]{ 
    \label{sub2} 
    \includegraphics[width=2.0in]{Images/g12.pdf} 
  } 
...
\begin{figure} 
  \centering 
  \subfigure[Beta RMSE when n=500]{ 
    \label{sub3}
    \includegraphics[width=2.0in]{Images/g10.pdf} 
  } 
  \subfigure[Beta Variance when n=500]{ 
    \label{sub4} 
    \includegraphics[width=2.0in]{Images/g13.pdf} 
  } 
  \caption{Distribution of the datasets} 
  \label{para2} 
\end{figure}
...
\begin{figure} 
  \centering 
  \subfigure[Beta RMSE when n=2000]{ 
    \label{sub5}
    \includegraphics[width=2.0in]{Images/g11.pdf} 
  } 
  \subfigure[Beta Variance when n=2000]{ 
    \label{sub6} 
    \includegraphics[width=2.0in]{Images/g14.pdf} 
  } 
  \caption{Distribution of the datasets} 
  \label{para3} 
\end{figure}
...
- Lasso performs better on parameter estimation than forward when n is small
